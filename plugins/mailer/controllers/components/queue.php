<?php
	...
	class QueueComponent extends Object {
		 ...
		 * 
		 * @param string $email_message_recipient_id
		 * @param integer $priority
		 * @return boolean
		 */
		public function setPriority($email_message_recipient_id, $priority = 0) {
		 ...
		 * @return boolean
		 */
		public function addVariable($email_message_recipient_id, $key, $value) {
		 ...
		 * @return boolean
		 */
		public function addAttachment($email_message_recipient_id, $file, $type, $name) {
