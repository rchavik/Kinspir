 ...
 * @access protected
 */
	protected $__allowedRatings = array('g', 'pg', 'r', 'x');
 ...
 * @access protected
 */
	protected $__defaultIcons = array('none', 'identicon', 'monsterid', 'wavatar', '404');
 ...
 * @access protected
 */
	protected function __emailHash($email, $type) {
 ...
 * @access protected
 */
	protected function __buildOptions($options = array()) {
