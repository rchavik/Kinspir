 ...
 */
	function __construct() {
		$messages = array(
			...
			'InvalidMime' => array(
				'message' => __d('meio_upload', 'Invalid file type. Only images are currently supported.', true)
			),
			'InvalidExt' => array(
				'message' => __d('meio_upload', 'Invalid file extension. Only images are currently supported.', true)
			),
			'MinWidth' => array(
