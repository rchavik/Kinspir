...
class GitShellShell extends Shell {
	 ...
	 * @var string
	 */
	var $uses = array('Project', 'ProjectPermission', 'Commit');
...
*/	$username = null;
		...
		if ($this->actionMap[$command] == 'r') {
			...
			$allowed = $this->ProjectPermission->check('refs/heads/master', array(
				'user' => $this->params['user'],
				'group' => $this->ProjectPermission->group($this->Project->id, $this->params['user']),
				'access' => 'r',
